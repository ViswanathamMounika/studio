                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
                                <div className="space-y-2">
                                    <div className="flex items-center gap-1.5">
                                        <Label className="text-[11px] font-bold text-slate-500">Configuration Area</Label>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Info className="h-3.5 w-3.5 text-slate-400 cursor-help" />
                                            </TooltipTrigger>
                                            <TooltipContent className="max-w-xs rounded-xl shadow-xl border-none p-3 bg-slate-900 text-white">
                                                <p className="text-[11px] font-bold uppercase tracking-wider mb-1 text-primary-foreground/60">Area Overview</p>
                                                <p className="text-xs leading-relaxed">{AREA_LABELS[activeArea].description}</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                    <Select value={activeArea} onValueChange={(v) => setActiveArea(v as ConfigArea)}>
                                ...
                                <div className="hidden md:block">
                                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                        ...
                                        <p className="text-xs text-slate-500 leading-relaxed font-medium">
                                            Changes to system settings are applied globally and affect all user accounts immediately upon finalization.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                {activeArea === 'general' && (
                                    <Card className="rounded-[28px] border-slate-200 overflow-hidden shadow-sm bg-white">
                                        <CardHeader className="bg-white border-b py-5 px-8 flex flex-row items-center gap-3">
                                            ...
                                            <CardTitle className="text-xl font-bold text-slate-900">General Identity</CardTitle>
                                        </CardHeader>
                                ...
                                {activeArea === 'email' && (
                                    <div className="space-y-6">
                                        {localConfig.emailTemplates.map(template => (
                                            <Card key={template.id} className="rounded-[28px] border-slate-200 overflow-hidden shadow-sm bg-white">
                                                <CardHeader className="bg-slate-50/50 border-b py-5 px-8 flex flex-row items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <CardDescription className="text-xs">System workflow notification</CardDescription>
                                                        </div>
                                                    </div>
                                                ...
                                                <CardContent className="p-8 space-y-6">
                                                    <div className="space-y-2">
                                                        ...
                                                        <Input 
                                                            ...
                                                            className="rounded-xl h-11 border-slate-200 font-bold bg-white"
                                                        />
                                                    </div>
                                                    <div className="space-y-2">
                                                        <Label className="text-[11px] font-black uppercase text-slate-500 tracking-wider">Template Body</Label>
                                                        <Textarea 
                                                            value={template.body} 
                                                            onChange={e => updateEmailTemplate(template.id, { body: e.target.value })}
                                                            className="rounded-2xl border-slate-200 min-h-[160px] font-mono text-xs leading-relaxed bg-white"
                                                        />
                                                    </div>
                                                </CardContent>
                                            </Card>
                                ...
                                {activeArea === 'localization' && (
                                    <Card className="rounded-[28px] border-slate-200 overflow-hidden shadow-sm bg-white">
                                        <CardHeader className="bg-white border-b py-5 px-8 flex flex-row items-center gap-3">
                                            ...
                                            <CardTitle className="text-xl font-bold text-slate-900">Regional Standards</CardTitle>
                                        </CardHeader>
                                        <CardContent className="p-8">
                                ...
                                {activeArea === 'security' && (
                                    <Card className="rounded-[28px] border-slate-200 overflow-hidden shadow-sm bg-white">
                                        <CardHeader className="bg-white border-b py-5 px-8 flex flex-row items-center gap-3">
                                            ...
                                            <CardTitle className="text-xl font-bold text-slate-900">Security & Files</CardTitle>
                                        </CardHeader>
